...
func (agb *AdminGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(agb.fields) > 1 {
		return nil, errors.New("models: AdminGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := agb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (agb *AdminGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{admin.Label}
	default:
		err = fmt.Errorf("models: AdminGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (agb *AdminGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(agb.fields) > 1 {
		return nil, errors.New("models: AdminGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := agb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (agb *AdminGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{admin.Label}
	default:
		err = fmt.Errorf("models: AdminGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (agb *AdminGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(agb.fields) > 1 {
		return nil, errors.New("models: AdminGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := agb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (agb *AdminGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{admin.Label}
	default:
		err = fmt.Errorf("models: AdminGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (agb *AdminGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(agb.fields) > 1 {
		return nil, errors.New("models: AdminGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := agb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (agb *AdminGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{admin.Label}
	default:
		err = fmt.Errorf("models: AdminGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (as *AdminSelect) Strings(ctx context.Context) ([]string, error) {
	if len(as.fields) > 1 {
		return nil, errors.New("models: AdminSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := as.Scan(ctx, &v); err != nil {
		return nil, err
...
func (as *AdminSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{admin.Label}
	default:
		err = fmt.Errorf("models: AdminSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (as *AdminSelect) Ints(ctx context.Context) ([]int, error) {
	if len(as.fields) > 1 {
		return nil, errors.New("models: AdminSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := as.Scan(ctx, &v); err != nil {
		return nil, err
...
func (as *AdminSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{admin.Label}
	default:
		err = fmt.Errorf("models: AdminSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (as *AdminSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(as.fields) > 1 {
		return nil, errors.New("models: AdminSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := as.Scan(ctx, &v); err != nil {
		return nil, err
...
func (as *AdminSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{admin.Label}
	default:
		err = fmt.Errorf("models: AdminSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (as *AdminSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(as.fields) > 1 {
		return nil, errors.New("models: AdminSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := as.Scan(ctx, &v); err != nil {
		return nil, err
...
func (as *AdminSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{admin.Label}
	default:
		err = fmt.Errorf("models: AdminSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
