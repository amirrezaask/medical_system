...
func (uc *UserCreate) check() error {
	...
	if _, ok := uc.mutation.UserType(); !ok {
		return &ValidationError{Name: "user_type", err: errors.New(`models: missing required field "user_type"`)}
	}
	...
	if _, ok := uc.mutation.NationalCode(); !ok {
		return &ValidationError{Name: "national_code", err: errors.New(`models: missing required field "national_code"`)}
	}
	if _, ok := uc.mutation.PasswordHash(); !ok {
		return &ValidationError{Name: "password_hash", err: errors.New(`models: missing required field "password_hash"`)}
	}
	return nil
}
